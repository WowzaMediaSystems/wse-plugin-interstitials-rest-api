...
package com.wowza.wms.plugin.adinserter.httpprovider;
...
import com.wowza.wms.plugin.adinserter.ReleaseInfo;
...
public class HTTPProviderAdInserter extends HTTPProvider2Base
{
	...
	public HTTPProviderAdInserter()
	{
		log = WMSLoggerFactory.getLogger(HTTPProviderAdInserter.class);
		log.info("Creating HTTPProvider AdInserter v"+ ReleaseInfo.getVersion());
...
//	}
	...
	public void onHTTPRequest(IVHost ivHost, IHTTPRequest ihttpRequest, IHTTPResponse ihttpResponse) {
		...
		// curl -X POST "http://localhost:1935/v1/ads/applications/simu-live/streams/myStream -d '{ "id":"foo" }'
